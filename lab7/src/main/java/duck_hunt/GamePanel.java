...
public class GamePanel extends JPanel {
  ...
  private ImageIcon background = new ImageIcon(getClass().getResource("/background2.png"));
  ...
  GamePanel(GameCreator gameCreator) {
    ...
    bestScore = new JLabel("Max Killed: 0");
    ...
    Cursor c = toolkit.createCustomCursor(image, new Point(getX() + 14, getY() + 14), "breech-sight");
    setCursor(c);
  ...
  synchronized void changedCoins(int d) {
    ...
    score.setText("Killed: " + coins);
    bestScore.setText("Max Killed: " + maxCoins);
  }
